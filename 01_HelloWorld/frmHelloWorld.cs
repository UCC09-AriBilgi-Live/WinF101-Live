namespace _01_HelloWorld
{
    ...
    public partial class frmHelloWorld : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMessage.Text = "Mesajýnýz var....."; // formun title
                frmMessage.lbelMessage.Text = "Merhaba sevgili " + tboxAd.Text + " " + tboxSoyad.Text.ToUpper() + "....Bugün nassýn?.."; // Modifiers a dikkat
